...
function addArtist(array) {
  let obj = {
    ...
    bio: "Lorem ipsum bingo bango bongo boom boom pow",
  };
  array.push(obj);
  return array;
}
...
*/
function artistInfo(array, painter) {
  let bioArr = [];
  for (let i = 0; i < array.length; i++) {
    if (array[i].name === painter) {
